...
name: senior-mobile
description: >-
  Expert mobile development across iOS, Android, React Native, and Flutter —
  project scaffolding, MVVM features, static performance analysis, and App Store /
  Play Store submission. Use when building Flutter/mobile features, choosing a
  mobile platform, diagnosing mobile performance, or preparing store listings.
