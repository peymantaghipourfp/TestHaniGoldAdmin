...
import '../model/today_deposit_request_report.model.dart';
import '../model/today_payment_report.model.dart';
import '../model/today_withdraw_request_report.model.dart';


enum PageState{loading,err,empty,list}
enum TodayPaymentReportLoadState { idle, loading, success, empty, error }
enum TodayWithdrawRequestReportLoadState { idle, loading, success, empty, error }
enum TodayDepositRequestReportLoadState { idle, loading, success, empty, error }

class _TodayPaymentReportCacheEntry {
  TodayPaymentReportLoadState state;
  TodayPaymentReportModel? data;
  String? errorMessage;

  _TodayPaymentReportCacheEntry({
    this.state = TodayPaymentReportLoadState.idle,
    this.data,
    this.errorMessage,
  });
}

class _TodayWithdrawRequestReportCacheEntry {
  TodayWithdrawRequestReportLoadState state;
  List<TodayWithdrawRequestReportModel>? data;
  String? errorMessage;

  _TodayWithdrawRequestReportCacheEntry({
    this.state = TodayWithdrawRequestReportLoadState.idle,
    this.data,
    this.errorMessage,
  });
}

class _TodayDepositRequestReportCacheEntry {
  TodayDepositRequestReportLoadState state;
  List<TodayDepositRequestReportModel>? data;
  String? errorMessage;

  _TodayDepositRequestReportCacheEntry({
    this.state = TodayDepositRequestReportLoadState.idle,
    this.data,
    this.errorMessage,
  });
}
class WithdrawController extends BaseController{
  ...
  Future<TodayPaymentReportModel?> _fetchTodayPaymentReport(
    ...
    try {
      ...
      _todayPaymentReportCache[cacheKey] = _TodayPaymentReportCacheEntry(
        state: TodayPaymentReportLoadState.error,
        errorMessage: 'خطا در دریافت گزارش پرداخت‌های امروز',
      );
      return null;
    } finally {
      _todayPaymentReportInFlight.remove(cacheKey);
  ...
  Future<List<TodayWithdrawRequestReportModel>?> _fetchTodayWithdrawRequestReport(
    ...
    try {
      ...
      _todayWithdrawRequestReportCache[cacheKey] =
          _TodayWithdrawRequestReportCacheEntry(
        state: TodayWithdrawRequestReportLoadState.error,
        errorMessage: 'خطا در دریافت درخواست‌های برداشت امروز',
      );
      return null;
    } finally {
  ...
  Future<List<TodayDepositRequestReportModel>?> _fetchTodayDepositRequestReport(
    ...
    try {
      ...
      _todayDepositRequestReportCache[cacheKey] =
          _TodayDepositRequestReportCacheEntry(
        state: TodayDepositRequestReportLoadState.error,
        errorMessage: 'خطا در دریافت تعهدات پرداخت امروز',
      );
      return null;
    } finally {
