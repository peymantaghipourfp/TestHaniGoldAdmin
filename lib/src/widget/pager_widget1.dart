...
class PagerWidget1 extends StatelessWidget {
  final int countPage;
  final SelectPagerCountCallBack callBack;
  const PagerWidget1({super.key, required this.countPage, required this.callBack});
        ...
        child:   SizedBox(
          ...
          child:countPage!=0? SfDataPagerTheme(
            ...
            child: SfDataPager(
              ...
              direction: Axis.horizontal, pageCount:listStr.isNotEmpty? ((countPage.toDouble()/10)+1):(countPage.toDouble()/10),
            ),
          ):SizedBox(),
        )
    );
