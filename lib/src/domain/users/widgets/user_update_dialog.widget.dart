...
class UserUpdateDialogWidget extends StatefulWidget {
  ...
  @override
  State<UserUpdateDialogWidget> createState() => _UserUpdateDialogWidgetState();
}

class _UserUpdateDialogWidgetState extends State<UserUpdateDialogWidget>
    with SingleTickerProviderStateMixin {

  late UserUpdateDialogController controller;

  // For draggable functionality
  Offset _dialogOffset = Offset.zero;

  UserUpdateDialogController _getOrCreateController() {
    if (Get.isRegistered<UserUpdateDialogController>()) {
      return Get.find<UserUpdateDialogController>();
    } else {
      return Get.put(UserUpdateDialogController());
    }
  }
  ...
  void _showConfirmDialog() {
    Get.defaultDialog(
      ...
      middleText: "آیا از بروزرسانی اطلاعات کاربر مطمئن هستید؟",
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          SizedBox(width: 8),
                          Text('بروزرسانی کاربر', style: AppTextStyle.smallTitleText),
                        ],
                      ),
                      IconButton(
                        onPressed: () {
