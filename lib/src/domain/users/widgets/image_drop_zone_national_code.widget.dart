...
class ImageDropZoneNationalCode extends StatefulWidget {
  final UserCreateDialogController controller;
  final bool isDesktop;

  const ImageDropZoneNationalCode({
    super.key,
  ...
  @override
  State<ImageDropZoneNationalCode> createState() => _ImageDropZoneNationalCodeState();
}

class _ImageDropZoneNationalCodeState extends State<ImageDropZoneNationalCode> {
