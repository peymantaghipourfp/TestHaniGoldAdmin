...
class ImageDropZoneBusinessLicense extends StatefulWidget {
  final UserCreateDialogController controller;
  final bool isDesktop;

  const ImageDropZoneBusinessLicense({
    super.key,
  ...
  @override
  State<ImageDropZoneBusinessLicense> createState() => _ImageDropZoneBusinessLicenseState();
}

class _ImageDropZoneBusinessLicenseState extends State<ImageDropZoneBusinessLicense> {
