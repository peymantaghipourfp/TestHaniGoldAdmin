...
import '../controller/user_info_detail_gold_transaction.controller.dart';

class GoldTransactionFilterWidget extends StatefulWidget {
  final UserInfoDetailGoldTransactionController controller;
  final VoidCallback onFilterApplied;
  final VoidCallback onFilterCleared;

  const GoldTransactionFilterWidget({
    super.key,
  ...
  @override
  State<GoldTransactionFilterWidget> createState() =>
      _GoldTransactionFilterWidgetState();
}

class _GoldTransactionFilterWidgetState
    extends State<GoldTransactionFilterWidget> {
  @override
  ...
  bool _hasActiveFilters() {
    return widget.controller.dateStartController.text.isNotEmpty ||
        ...
        widget.controller.descriptionFilterController.text.isNotEmpty ||
        widget.controller.amountFilterController.text.isNotEmpty ||
        (widget.controller.selectedItemFilter.value!=null && widget.controller.selectedItemFilter.value != 'انتخاب محصول' ) ||
        (widget.controller.typeFilter.value != null &&
            widget.controller.typeFilter.value != 'انتخاب کنید' &&
            widget.controller.typeFilter.value.isNotEmpty);
  }
        ...
        return Center(
          child: Material(
            ...
            child: Container(
              ...
              width: isDesktop ? Get.width * 0.25 : Get.height * 0.5,
              height: isDesktop ? Get.height * 0.75 : Get.height * 0.74,
    ...
    return Column(
      ...
      children: [
        ...
        Container(
          padding: EdgeInsets.only(bottom: 5),
          child: TextField(
            controller: widget.controller.descriptionFilterController,
            onChanged: (value) {
              widget.controller.descriptionFilter.value = value;
            },
      ...
      Column(
        ...
        children: [
          ...
          Obx(() => DropdownButtonFormField<ItemModel>(
            value: widget.controller.selectedItemFilter.value,
            ...
            items: widget.controller.itemList.map((ItemModel item) {
            ...
            onChanged: (ItemModel? newValue) {
              widget.controller.changeSelectedItemFilter(newValue);
            },
          )),
        ],
      );
  ...
  Widget _buildFilterButton(bool isDesktop) {
    return Container(
      ...
      child: ElevatedButton(
        style: ButtonStyle(
            padding: WidgetStatePropertyAll(
                EdgeInsets.symmetric(horizontal:isDesktop ? 23 : 5, vertical:isDesktop ? 19 : 0)
            ),
