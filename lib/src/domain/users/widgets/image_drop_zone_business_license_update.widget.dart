...
class ImageDropZoneBusinessLicenseUpdate extends StatefulWidget {
  final UserUpdateDialogController controller;
  final bool isDesktop;

  const ImageDropZoneBusinessLicenseUpdate({
    super.key,
  ...
  @override
  State<ImageDropZoneBusinessLicenseUpdate> createState() => _ImageDropZoneBusinessLicenseUpdateState();
}

class _ImageDropZoneBusinessLicenseUpdateState extends State<ImageDropZoneBusinessLicenseUpdate> {
