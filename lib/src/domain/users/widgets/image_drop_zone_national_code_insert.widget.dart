...
class ImageDropZoneNationalCodeInsert extends StatefulWidget {
  final InsertUserController controller;
  final bool isDesktop;

  const ImageDropZoneNationalCodeInsert({
    super.key,
  ...
  @override
  State<ImageDropZoneNationalCodeInsert> createState() => _ImageDropZoneNationalCodeInsertState();
}

class _ImageDropZoneNationalCodeInsertState extends State<ImageDropZoneNationalCodeInsert> {
