...
class ImageDropZoneNationalCodeUpdate extends StatefulWidget {
  final UserUpdateDialogController controller;
  final bool isDesktop;

  const ImageDropZoneNationalCodeUpdate({
    super.key,
  ...
  @override
  State<ImageDropZoneNationalCodeUpdate> createState() => _ImageDropZoneNationalCodeUpdateState();
}

class _ImageDropZoneNationalCodeUpdateState extends State<ImageDropZoneNationalCodeUpdate> {
    ...
    try {
      ...
      if (files != null && files.length > 0) {
        ...
        if (xFiles.isNotEmpty) {
          widget.controller.handleDroppedFilesNationalCode(xFiles);
        } else {
