...
/// ریال debit / credit / running-balance (item.id == 6, sell debit, buy credit).
class GoldTransactionRialCell {
  GoldTransactionRialCell._();
  ...
  static Widget balanceSection({required TransactionReportGoldModel trans}) {
    final running = trans.cashTotalRunning;
