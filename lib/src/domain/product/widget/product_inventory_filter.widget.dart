...
import '../controller/product_inventory.controller.dart';


class ProductInventoryFilterWidget extends StatefulWidget {
  final ProductInventoryController controller;
  final VoidCallback onFilterApplied;
  final VoidCallback onFilterCleared;

  const ProductInventoryFilterWidget({
    super.key,
  ...
  @override
  State<ProductInventoryFilterWidget> createState() =>
      _ProductInventoryFilterWidgetState();
}

class _ProductInventoryFilterWidgetState
    extends State<ProductInventoryFilterWidget> {
  @override
