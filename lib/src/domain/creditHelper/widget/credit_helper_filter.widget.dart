...
class CreditHelperFilterWidget extends StatefulWidget {
  ...
  const CreditHelperFilterWidget({
    super.key,
  ...
  @override
  State<CreditHelperFilterWidget> createState() =>
      _CreditHelperFilterWidgetState();
}

class _CreditHelperFilterWidgetState
    extends State<CreditHelperFilterWidget> {
  @override
  ...
  bool _hasActiveFilters() {
    return widget.controller.dateStartController.text.isNotEmpty ||
        ...
        (widget.controller.selectedItemFilter.value != null) ||
        widget.controller.typeFilter.value.isNotEmpty ||
        widget.controller.amountController.text.isNotEmpty;
  }
        ...
        return Center(
          child: Material(
            ...
            child: Container(
              ...
              height: isDesktop ? Get.height * 0.7 : Get.height * 0.8,
        ...
        Container(
          ...
          child: Obx(() {
            return CustomDropdownWidget(
              ...
              selectedValue: widget.controller.typeFilter.value.isEmpty ? 'انتخاب کنید' : widget.controller.typeFilter.value,
              onChanged: (String? newValue) {
                if (newValue != null && newValue != 'انتخاب کنید') {
                  widget.controller.changeSelectedType(newValue);
                } else {
                  widget.controller.changeSelectedType('');
                }
              },
  ...
  Widget _buildAccountNameField() {
    return Column(
      ...
      children: [
        ...
        SizedBox(height: 8),
        TextFormField(
          controller: widget.controller.accountNameController,
          style: AppTextStyle.labelText.copyWith(fontSize: 15),
          ...
          decoration: InputDecoration(
            ...
            hintStyle: AppTextStyle.labelText.copyWith(fontSize: 11,color: AppColor.textColor.withAlpha(150)),
          ),
          onChanged: (value) {
            widget.controller.accountNameFilter.value = value;
          },
        ),
      ],
    );
