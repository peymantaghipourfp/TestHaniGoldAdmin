...
class DepositsListView extends StatelessWidget {
                ...
                child: SizedBox(
                  ...
                  child:
                      SingleChildScrollView(
                        controller:isDesktop ? null : depositController.scrollControllerMobile,
                        child: Column(
                          children: [
                            isDesktop?
                            SizedBox.shrink() :
                                     ...
                                     : Padding(
                                      ...
                                      child: Column(
                                        children: [
                                             ...
                                             physics: NeverScrollableScrollPhysics(),
                                                ...
                                                itemBuilder: (context, index) {
                                                  ...
                                                  return Container(
                                                    ...
                                                    decoration: BoxDecoration(
                                                      color: deposits.registered==true && deposits.status!=4 ? AppColor.primaryColor.withAlpha(40) : deposits.status==4 ? AppColor.accentColor.withAlpha(40): AppColor.secondaryColor.withAlpha(180),
                                                              ...
                                                              children: [
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Row(
                                                                          children: [
                                                                            ...
                                                                            Text(
                                                                              "${deposits.extraAmount == null ? 0 : deposits.extraAmount?.toInt().toString().seRagham(separator: ',')} ریال",
                                                                              style:
                                                                ...
                                                                Row(
                                                                  ...
                                                                  children: [
                                                                    Row(
                                                                      children: [
                                                                        Text('وضعیت: ',style: AppTextStyle
                                                                            .bodyText),
                                                                        Text(
                                                                          '${deposits.status == 0 ? 'در انتظار' : deposits.status == 1
                                                                              ? 'تایید شده'
                                                                              :deposits.status == 2 ? 'تایید نشده' : deposits.status == 4 ? "برگشتی" : "ویرایش شده"} ',
                                                                          style: AppTextStyle
                                                                              .bodyText.copyWith(
                                                                    ...
                                                                    // Popup تعیین وضعیت
                                                                    deposits.status == 4 ? SizedBox.shrink() :
                                                                    Center(
                                                                      child: Transform.scale(
                                                                        scale: 0.75,
                                                                        child: Switch(
                                                                          value: deposits.status == 1,
                                                                          onChanged: deposits.status == 0 || deposits.status == 4
                                                                              ? null // Disable switch for pending or returned status
                                                                              : (value) async {
                                                                            // پذیرش = 1، عدم پذیرش = 2
                                                                            ...
                                                                            if (newStatus == 2) {
                                                                              ...
                                                                              depositController.selectedReasonRejection.value = null;
                                                                          ...
                                                                          thumbColor: WidgetStateProperty.resolveWith<Color>((states) {
                                                                            if (states.contains(WidgetState.disabled) ||
                                                                                deposits.status == 0 || deposits.status == 4) {
                                                                ...
                                                                Row(mainAxisAlignment: MainAxisAlignment
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    GestureDetector(
                                                                      onTap: () {
                                                                        ...
                                                                        Get.defaultDialog(
                                                                            ...
                                                                            confirm: ElevatedButton(
                                                                                ...
                                                                                onPressed: () {
                                                                                  Get.back();
                                                                                  depositController.sendTelegramDeposit(deposits.id ?? 0);
                                                                                },
                                                                                child: Text(
                                                                                  'ارسال مجدد',
                                                                                  style: AppTextStyle.bodyText,
                                                                      ...
                                                                      child: Tooltip(
                                                                        message: deposits.isSendTelegram == true ?  "ارسال مجدد واریزی به تلگرام" : "ارسال واریزی به تلگرام",
                                                                        child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                                                          children: [
                                                                            Text(' ارسال',style: AppTextStyle.labelText.copyWith(color: deposits.isSendTelegram == true ? AppColor.successColor : Color(0xff0ab6f0), fontSize: 11,fontWeight: FontWeight.w400),),
                                                                            SvgPicture.asset(
                                                                              'assets/svg/telegram.svg',height: 20,
                                                                              colorFilter: ColorFilter.mode(deposits.isSendTelegram == true ? AppColor.successColor : Color(0xff0ab6f0), BlendMode.srcIn) ,
                                                                            ),
                                                                          ],
                                                                        ),
                                                                      ),
                                          ...
                                          Obx(() {
                                            if (depositController.isLoading.value && depositController.depositList.isNotEmpty) {
                                              return Container(
                                            ...
                                            if (!depositController.hasMore.value && depositController.depositList.isNotEmpty) {
                                              return Container(
                                                padding: EdgeInsets.all(16),
                                                child: Text(
  ...
  List<DataColumn> buildDataColumns() {
    return [
      ...
      DataColumn(label: ConstrainedBox(constraints: BoxConstraints(maxWidth: 80),
          child: Text('ارسال تلگرام', style: AppTextStyle.labelText)),headingRowAlignment:MainAxisAlignment.center ),
      DataColumn(
      ...
      DataColumn(label: ConstrainedBox(constraints: BoxConstraints(maxWidth: 80),
          child: Text('اضافه واریزی', style: AppTextStyle.labelText)),
          headingRowAlignment:MainAxisAlignment.center,
          onSort: (columnIndex, ascending) {
            depositController.onSort(columnIndex, ascending);
          }
      ...
      DataColumn(label: ConstrainedBox(constraints: BoxConstraints(maxWidth: 80),
          child: Text('تلگرام', style: AppTextStyle.labelText)),headingRowAlignment:MainAxisAlignment.center ),
      DataColumn(label: ConstrainedBox(constraints: BoxConstraints(maxWidth: 80),
  ...
  List<DataRow> buildDataRows(BuildContext context) {
    return depositController.depositList.asMap().entries.map((entry) {
      ...
      return DataRow(
        color: WidgetStateProperty.all(deposit.registered==true && deposit.status!=4 ? AppColor.primaryColor.withAlpha(40) :
        deposit.status==4 ? AppColor.accentColor.withAlpha(40):
        rowColor,),
        cells: [
          // ردیف
          DataCell(
          ...
          DataCell(
            ...
            GestureDetector(
              onTap: () {
                ...
                Get.defaultDialog(
                    ...
                    confirm: ElevatedButton(
                        ...
                        onPressed: () {
                          Get.back();
                          depositController.sendTelegramDeposit(deposit.id ?? 0);
                        },
                        child: Text(
                          'ارسال مجدد',
                          style: AppTextStyle.bodyText,
              ...
              child: Tooltip(
                message: deposit.isSendTelegram == true ?  "ارسال مجدد واریزی به تلگرام" : "ارسال واریزی به تلگرام",
                child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Text(' ارسال',style: AppTextStyle.labelText.copyWith(color: deposit.isSendTelegram == true ? AppColor.successColor : Color(0xff0ab6f0), fontSize: 11,fontWeight: FontWeight.w400),),
                    SvgPicture.asset(
                      'assets/svg/telegram.svg',height: 20,
                      colorFilter: ColorFilter.mode(deposit.isSendTelegram == true ? AppColor.successColor : Color(0xff0ab6f0), BlendMode.srcIn) ,
                    ),
                  ],
                ),
              ),
          ...
          DataCell(
              Center(
                child: Text(
                  "${deposit.extraAmount == null ? 0 : deposit.extraAmount?.toInt().toString().seRagham(separator: ',')} ریال",
                  style:
                  AppTextStyle.bodyText,
                ),
              )),
          ...
          DataCell(
              Center(
                child: GestureDetector(
                  ...
                  child: Row(
                    children: [
                      Text('مشاهده درخواست ',style: AppTextStyle.labelText.copyWith(color: AppColor.iconViewColor,fontWeight: FontWeight.bold),),
                      Container(
                        width: 30,
                        height: 25,
                        child: SvgPicture.asset(
                ...
                children: [
                  ...
                  /*Text(
                    '${deposit.status == 0 ? 'در انتظار' : deposit.status == 1
                        ? 'تایید شده'
                        :deposit.status == 2 ? 'تایید نشده' : deposit.status == 4 ? "برگشتی" : "ویرایش شده"} ',
                    style: AppTextStyle
                        .bodyText.copyWith(
                      color: deposit.status == 1
                          ...
                          ? AppColor.accentColor
                          : AppColor.textColor,
                      fontWeight: deposit.status == 4 ? FontWeight.bold :FontWeight.normal
                    ),
                  ),*/
                  //SizedBox(height: 6,),
                  deposit.status == 4 ? SizedBox.shrink() :
                  /*Container(
                  ...
                  Center(
                    child: Transform.scale(
                      scale: 0.70,
                      child: Switch(
                        value: deposit.status == 1,
                        onChanged: deposit.status == 0 || deposit.status == 4
                            ? null // Disable switch for pending or returned status
                            : (value) async {
                          // پذیرش = 1، عدم پذیرش = 2
                          final newStatus = value ? 1 : 2;
                        ...
                        thumbColor: WidgetStateProperty.resolveWith<Color>((states) {
                          if (states.contains(WidgetState.disabled) ||
                              deposit.status == 0 || deposit.status == 4) {
                            return AppColor.dividerColor;
                          }
                      ...
                      showDialog(
                        ...
                        builder: (BuildContext context) {
                          return BalanceDateDialog(
                            accountId: deposit.wallet?.account?.id ?? 0,
                            accountName: deposit.wallet?.account?.name ?? "",
                            initialDate: deposit.date.toString(),
