...
class _ItemTempDetailWidgetPayment extends State<ItemTempDetailWidgetPayment> {
  ...
  InventoryCreatePaymentController inventoryCreatePaymentController =
  Get.find<InventoryCreatePaymentController>();
              ...
              if (widget.detail.item?.id == 1) ...[
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border:
                    Border.all(color: AppColor.primaryColor.withAlpha(75)),
                  ),
                  child: Text(
                    'وزن محاسبه شده: ${((widget.detail.quantity ?? 0) * (widget.detail.carat ?? 0) / 750).toStringAsFixed(4)}',
                    style: AppTextStyle.bodyText.copyWith(
